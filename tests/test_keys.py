...
def test_delete_key(registry, rando, gov):
    ...
    assert registry.keyByAddress("0x63cF44B2548e4493Fd099222A1eC79F3344D9682") == ""
...
def test_delete_keys(registry, rando, gov):
    ...
    assert registry.get("controller") == "0x63cF44B2548e4493Fd099222A1eC79F3344D9682"
    assert registry.keyByAddress("0x63cF44B2548e4493Fd099222A1eC79F3344D9682") == "controller"
    assert registry.get("ibBTC") == "0xc4E15973E6fF2A35cC804c2CF9D2a1b817a8b40F"
    assert registry.keyByAddress("0xc4E15973E6fF2A35cC804c2CF9D2a1b817a8b40F") == "ibBTC"
    assert registry.keysCount() == 2
    ...
    assert registry.keyByAddress("0xc4E15973E6fF2A35cC804c2CF9D2a1b817a8b40F") == ""
    assert registry.keysCount() == 0
